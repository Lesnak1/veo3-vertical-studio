...
# --- Configuration ---
MAX_FILE_SIZE_MB = 50   # Reduced for Vercel Hobby plan
MAX_VIDEO_DURATION_SECONDS = 60  # 1 minute for Hobby plan limits

# FFmpeg static binary URLs for serverless deployment
...
st.info("🌐 **Serverless Mode** - Optimized for fast cloud processing!")
